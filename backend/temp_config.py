"""
Temporary configuration for development without full database access
"""
import os
...
os.environ['POSTGRES_PASSWORD'] = 'placeholder-password'
os.environ['POSTGRES_DATABASE'] = 'postgres'
os.environ['SECRET_KEY'] = 'django-secret-key-for-development-only'
os.environ['DEBUG'] = 'true'

print("🔧 Temporary configuration loaded!")
print("📝 Note: Replace placeholders with actual credentials for full functionality")
