...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('[Fresh Leads] Params:', { teamLeaderId, dateRange, psMember, startDate, endDate })
    ...
    if (!response.ok) {
      ...
      console.error('[FreshLeads API] Backend error:', response.status, errorText)
    ...
    console.error('[FreshLeads API] Error:', error)
    return NextResponse.json(
      {
